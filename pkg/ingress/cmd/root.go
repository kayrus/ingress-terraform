...
import (
	...
	"github.com/kayrus/ingress-terraform/pkg/ingress/controller"
)
...
var rootCmd = &cobra.Command{
	Use:   "ingress-terraform",
	Short: "Terraform based Ingress controller",
	Long:  `Terraform based Ingress controller`,
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".ingress_terraform")
	}
